 ...
 */
public class ManageLecturers extends ManageUser{
    ...
    //add new lecturer
    public void addUser(int id,int lec) throws SQLException{              
        String userInfo = "insert into lecturers values(?, ?)";
    ...
    //get total lecturers
    public int getLecCount() throws SQLException{
        pst1 = Db.connection().prepareStatement("select lecturerId from lecturers");
        ...
        while (rst1.next()) {
            id[count]=rst1.getInt("lecturerId");
            count++;
